...
@Size(max=35) 
  ...
  public PeriodicPaymentInitiationTarget2Json debtorAccount(AccountReference debtorAccount) {
  ...
  **/
  ...
  public PeriodicPaymentInitiationTarget2Json creditorAccount(AccountReference creditorAccount) {
