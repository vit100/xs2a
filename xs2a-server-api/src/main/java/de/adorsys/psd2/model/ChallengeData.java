...
public class ChallengeData {
    ...
    /**
     * PNG data (max. 512 kilobyte) to be displayed to the PSU, Base64 encoding, cp. [RFC4648]. This attribute is used
     * only, when PHOTO_OTP or CHIP_OTP is the selected SCA method.
     *
     * @return image
     **/
