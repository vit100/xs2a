 ...
 * status is returned as a pain.002 structure.   urn:iso:std:iso:20022:tech:xsd:pain.002.001.03  The chosen XML
 * schema of the Status Request is following the XML schema definitions of the original pain.001 schema.
 */
@ApiModel(description = "Body of the response for a successful payment initiation status request in case of an XML " +
    "based endpoint.  The status is returned as a pain.002 structure.   urn:iso:std:iso:20022:tech:xsd:pain.002.001" +
    ".03  The chosen XML schema of the Status Request is following the XML schema definitions of the original pain" +
    ".001 schema. ")
@Validated
