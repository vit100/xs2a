 ...
 * cancellation needs to be started,      but no additional data needs to be updated for time being (no
 * authentication method to be selected,      no PSU identification nor PSU authentication data to be uploaded).   *
 * &#39;startAuthorisationWithPsuIdentification&#39;:      In case where a PSU Identification needs to be updated
 * when starting the cancellation authorisation:      The link to the cancellation-authorisations end-point, where
 * the cancellation sub-resource has to be      generated while uploading the PSU identification data.   * &#39;
