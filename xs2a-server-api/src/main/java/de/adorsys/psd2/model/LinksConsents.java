...
/**
 * A list of hyperlinks to be recognised by the TPP.  Type of links admitted in this response (which might be
 * extended by single ASPSPs as indicated in its XS2A  documentation):   - &#39;scaRedirect&#39;:      In case of an
 * SCA Redirect Approach, the ASPSP is transmitting the link to which to redirect the      PSU browser.   - &#39;
 * scaOAuth&#39;:      In case of an OAuth2 based Redirect Approach, the ASPSP is transmitting the link where the
 * configuration      of the OAuth2 Server is defined.      The configuration follows the OAuth 2.0 Authorisation
 * Server Metadata specification.    - &#39;startAuthorisation&#39;:      In case, where an explicit start of the
 * transaction authorisation is needed,      but no more data needs to be updated (no authentication method to be
 * selected,      no PSU identification nor PSU authentication data to be uploaded).   - &#39;
 * startAuthorisationWithPsuIdentification&#39;:      The link to the authorisation end-point, where the
 * authorisation sub-resource has to be generated      while uploading the PSU identification data.   - &#39;
 * startAuthorisationWithPsuAuthentication&#39;:     The link to the authorisation end-point, where the authorisation
 ...
 * received by SMS.   - &#39;self&#39;:      The link to the Establish Account Information Consent resource created
 * by this request.      This link can be used to retrieve the resource data.    - &#39;status&#39;:      The link to
 * retrieve the status of the account information consent.   - &#39;scaStatus&#39;: The link to retrieve the
 * scaStatus of the corresponding authorisation sub-resource.      This link is only contained, if an authorisation
...
@ApiModel(description = "A list of hyperlinks to be recognised by the TPP.  Type of links admitted in this response " +
    "(which might be extended by single ASPSPs as indicated in its XS2A  documentation):   - 'scaRedirect':      In " +
    "case of an SCA Redirect Approach, the ASPSP is transmitting the link to which to redirect the      PSU browser. " +
    "  - 'scaOAuth':      In case of an OAuth2 based Redirect Approach, the ASPSP is transmitting the link where the " +
    "configuration      of the OAuth2 Server is defined.      The configuration follows the OAuth 2.0 Authorisation " +
    "Server Metadata specification.    - 'startAuthorisation':      In case, where an explicit start of the " +
    "transaction authorisation is needed,      but no more data needs to be updated (no authentication method to be " +
    "selected,      no PSU identification nor PSU authentication data to be uploaded).   - " +
    "'startAuthorisationWithPsuIdentification':      The link to the authorisation end-point, where the authorisation" +
    " sub-resource has to be generated      while uploading the PSU identification data.   - " +
    "'startAuthorisationWithPsuAuthentication':     The link to the authorisation end-point, where the authorisation " +
    "sub-resource has to be generated      while uploading the PSU authentication data.   - " +
    "'startAuthorisationWithAuthenticationMethodSelection':     The link to the authorisation end-point, where the " +
    "authorisation sub-resource has to be generated      while selecting the authentication method. This link is " +
    ...
    "'startAuthorisationWithTransactionAuthorisation':     The link to the authorisation end-point, where the " +
    "authorisation sub-resource has to be generated      while authorising the transaction e.g. by uploading an OTP " +
    "received by SMS.   - 'self':      The link to the Establish Account Information Consent resource created by this" +
    " request.      This link can be used to retrieve the resource data.    - 'status':      The link to retrieve the" +
    " status of the account information consent.   - 'scaStatus': The link to retrieve the scaStatus of the " +
    "corresponding authorisation sub-resource.      This link is only contained, if an authorisation sub-resource has" +
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.scaRedirect, _linksConsents.scaRedirect) &&
            ...
            Objects.equals(this.startAuthorisationWithPsuIdentification,
                _linksConsents.startAuthorisationWithPsuIdentification) &&
            Objects.equals(this.startAuthorisationWithPsuAuthentication,
                _linksConsents.startAuthorisationWithPsuAuthentication) &&
