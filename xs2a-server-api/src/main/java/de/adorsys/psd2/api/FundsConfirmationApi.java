...
public interface FundsConfirmationApi {
    ...
    @ApiOperation(value = "Confirmation of Funds Request", nickname = "checkAvailabilityOfFunds", notes = "Creates a " +
        "confirmation of funds request at the ASPSP. Checks whether a specific amount is available at point of time " +
        "of the request on an account linked to a given tuple card issuer(TPP)/card number, or addressed by IBAN and " +
        "TPP respectively", response = InlineResponse200.class, tags = {"Confirmation of Funds Service",})
    @ApiResponses(value = {
    ...
    default ResponseEntity<InlineResponse200> _checkAvailabilityOfFunds(@ApiParam(value = "Request body for a " +
        "confirmation of funds request. ", required = true) @Valid @RequestBody ConfirmationOfFunds body,
    ...
    default ResponseEntity<InlineResponse200> checkAvailabilityOfFunds(ConfirmationOfFunds body, UUID xRequestID,
