...
@NotNull
public interface CmsAspspPiisExportService {
    /**
     * Returns list of piis consents by given criteria.
     *
     ...
     * @return Collection of piis consents by given criteria.
     ...
     */
    Collection<CmsPiisConsent> exportPaymentsByAccountId(@NotNull String aspspAccountId,
