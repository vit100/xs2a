...
public interface CmsPsuPisService {
     ...
     */
    boolean updatePsuInPayment(@NotNull PsuIdData psuIdData, @NotNull String redirectId, String instanceId);
     ...
     */
    @NotNull
    Optional<CmsPayment> getPayment(@NotNull PsuIdData psuIdData, @NotNull String paymentId, String instanceId);
     ...
     */
    @NotNull
    Optional<CmsPaymentResponse> checkRedirectAndGetPayment(@NotNull PsuIdData psuIdData, @NotNull String redirectId, String instanceId);
     ...
     */
    boolean updateAuthorisationStatus(@NotNull PsuIdData psuIdData, @NotNull String paymentId, @NotNull String authorisationId, @NotNull ScaStatus status, String instanceId);
     ...
     * @return <code>true</code> if payment was found and status was updated. <code>false</code> otherwise.
     */
    boolean updatePaymentStatus(@NotNull String paymentId, @NotNull TransactionStatus status, String instanceId);
}
