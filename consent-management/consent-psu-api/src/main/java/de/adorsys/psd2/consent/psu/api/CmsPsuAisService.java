...
public interface CmsPsuAisService {
     ...
     */
    boolean updatePsuDataInConsent(@NotNull PsuIdData psuIdData, @NotNull String redirectId, String instanceId);
     ...
     */
    @NotNull
    Optional<AisAccountConsent> getConsent(@NotNull PsuIdData psuIdData, @NotNull String consentId, String instanceId);
     ...
     */
    boolean updateAuthorisationStatus(@NotNull PsuIdData psuIdData, @NotNull String consentId, @NotNull String authorisationId, @NotNull ScaStatus status, String instanceId);
     ...
     * @return <code>true</code> if consent was found and status was updated. <code>false</code> otherwise.
     */
    boolean confirmConsent(@NotNull PsuIdData psuIdData, @NotNull String consentId, String instanceId);
     ...
     * @return <code>true</code> if consent was found and status was updated. <code>false</code> otherwise.
     */
    boolean rejectConsent(@NotNull PsuIdData psuIdData, @NotNull String consentId, String instanceId);
     ...
     */
    @NotNull
    List<AisAccountConsent> getConsentsForPsu(@NotNull PsuIdData psuIdData, String instanceId);
     ...
     */
    boolean revokeConsent(@NotNull PsuIdData psuIdData, @NotNull String consentId, String instanceId);
     ...
     */
    @NotNull
    Optional<CmsAisConsentResponse> checkRedirectAndGetConsent(@NotNull PsuIdData psuIdData, @NotNull String redirectId, String instanceId);
