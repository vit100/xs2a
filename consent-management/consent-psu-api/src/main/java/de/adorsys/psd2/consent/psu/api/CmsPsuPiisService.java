...
public interface CmsPsuPiisService {
     ...
     */
    @NotNull
    Optional<PiisConsent> getConsent(@NotNull PsuIdData psuIdData, @NotNull String consentId, String instanceId);
     ...
     */
    @NotNull
    List<PiisConsent> getConsentsForPsu(@NotNull PsuIdData psuIdData, String instanceId);
