...
public enum AspspDayOfExecution {
    ...
    private final static Map<String, AspspDayOfExecution> container = new HashMap<>();

    static {
        for (AspspDayOfExecution day : values()) {
            container.put(day.getValue(), day);
        }
    }

    @JsonCreator
    AspspDayOfExecution(String value) {
        this.value = value;
    }
    ...
    public static Optional<AspspDayOfExecution> getByValue(String name) {
