...
@Repository
@Profile({"mongo", "fongo"})
public interface TransactionMongoRepository extends MongoRepository<SpiTransactionPO, String> {
    ...
    List<SpiTransactionPO> findAllByDates(String iban, Currency currency, LocalDate dateFrom, LocalDate dateTo);
    ...
    SpiTransactionPO findOneByTransactionIdAndAccount(String iban, Currency currency, String transactionId);
}
