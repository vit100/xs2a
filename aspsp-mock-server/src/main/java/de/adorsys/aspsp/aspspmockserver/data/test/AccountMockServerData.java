...
public class AccountMockServerData {
    ...
    private List<AspspAccountDetails> fillAccounts() {
        ...
        return Arrays.asList(getNewAccount("11111-11111", "11111-999999999", getNewBalanceList(EUR, BigDecimal.valueOf(1000)), "DE89370400440532013000", "AEYPM5403H", "DEUTDE8EXXX", "Müller", "SCT", Arrays.asList(new AspspPsuData("PSU_001", "psu-type", "123456", "corp-type"), new AspspPsuData("PSU_002", "psu-type", "123456", "corp-type"))),
                             getNewAccount("11111-11111", "77777-999999999", getNewBalanceList(USD, BigDecimal.valueOf(350)), "DE89370400440532013000", "FFGHPM5403H", "DEUTDE8EXXX", "Müller", "SCT", Arrays.asList(new AspspPsuData("PSU_001", "psu-type", "123456", "corp-type"), new AspspPsuData("PSU_002", "psu-type", "123456", "corp-type"))),
                             ...
                             getNewAccount("44444-44444", "44444-999999999", getNewBalanceList(USD, BigDecimal.valueOf(3500)), "DE89370400440532013003", "ASDPS9547Z", "DEUTDE8EXXX", "Schmidt", "SCT", Collections.singletonList(new AspspPsuData("PSU_001", "psu-type", "123456", "corp-type"))),
                             getNewAccount("55555-55555", "55555-999999999", getNewBalanceList(EUR, BigDecimal.valueOf(4000)), "DE89370400440532013004", "DSACC1876N", "DEUTDE8EXXX", "Company AG", "SCT", Collections.singletonList(new AspspPsuData("PSU_001", "psu-type", "123456", "corp-type"))),
