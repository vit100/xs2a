...
public class AccountServiceTest {
    ...
    private Psu getPsuWithRightAccounts() {
        return new Psu("12345678910", "test@gmail.com", "aspsp", "zzz", getAccounts(), null, Collections.singletonList(new AspspAuthenticationObject(AspspAuthenticationType.SMS_OTP, "SMS_OTP")))
            ;
    }
