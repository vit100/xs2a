...
public class PsuServiceTest {
    ...
    private Psu getPsu(String aspspPsuId, String email, String psuId, List<AspspAccountDetails> details, List<String> products) {
        return new Psu(aspspPsuId, email, psuId, PASSWORD, details, products, Collections.singletonList(new AspspAuthenticationObject(AspspAuthenticationType.SMS_OTP, "SMS_OTP")));
    }
