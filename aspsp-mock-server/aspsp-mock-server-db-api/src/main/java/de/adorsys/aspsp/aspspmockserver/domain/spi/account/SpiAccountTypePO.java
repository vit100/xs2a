...
public enum SpiAccountTypePO {
    ...
    private final static Map<String, SpiAccountTypePO> container = new HashMap<>();

    static {
        for (SpiAccountTypePO accountType : values()) {
    ...
    public static Optional<SpiAccountTypePO> getByValue(String value) {
