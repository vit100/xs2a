...
public class InitiatePayments_explicitTest {
    ...
    private static final String SINGLE_PAYMENT_RESPONSE_JSON_PATH = "/json/payment/res/explicit/SinglePaymentInitiateExplicit_response.json";

    private static final String PERIODIC_PAYMENT_REQUEST_JSON_PATH = "/json/payment/req/PeriodicPaymentInitiate_request.json";
    private static final String PERIODIC_PAYMENT_RESPONSE_JSON_PATH = "/json/payment/res/explicit/PeriodicPaymentInitiateExplicit_response.json";

    private static final String BULK_PAYMENT_REQUEST_JSON_PATH = "/json/payment/req/BulkPaymentInitiate_request.json";
    private static final String BULK_PAYMENT_RESPONSE_JSON_PATH = "/json/payment/res/explicit/BulkPaymentInitiateExplicit_response.json";
    ...
    private void initiateSinglePayment_successful(ScaApproach scaApproach) throws Exception {
        ...
        resultActions.andExpect(status().isCreated())
            ...
            .andExpect(content().json(IOUtils.resourceToString(SINGLE_PAYMENT_RESPONSE_JSON_PATH, UTF_8)));
    }
    ...
    private void initiatePeriodicPayment_successful(ScaApproach scaApproach) throws Exception {
        ...
        PisPaymentInfo pisPaymentInfo = new PisPaymentInfoBuilder().buildPisPaymentInfo(SEPA_PAYMENT_PRODUCT, PERIODIC_PAYMENT_TYPE, ASPSP_ACCOUNT_ID);
        ...
        resultActions.andExpect(status().isCreated())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8))
            .andExpect(content().json(IOUtils.resourceToString(PERIODIC_PAYMENT_RESPONSE_JSON_PATH, UTF_8)));
    }
    ...
    private void initiateBulkPayment_successful(ScaApproach scaApproach) throws Exception {
        ...
        PisPaymentInfo pisPaymentInfo = new PisPaymentInfoBuilder().buildPisPaymentInfo(SEPA_PAYMENT_PRODUCT, BULK_PAYMENT_TYPE, ASPSP_ACCOUNT_ID);
        ...
        resultActions.andExpect(status().isCreated())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8))
            .andExpect(content().json(IOUtils.resourceToString(BULK_PAYMENT_RESPONSE_JSON_PATH, UTF_8)));
    }
}
