...
public class Xs2aToSpiBulkPaymentMapper {
    ...
    public SpiBulkPayment mapToSpiBulkPayment(BulkPayment payment, String paymentProduct) {
        ...
        bulk.setPaymentProduct(SpiPaymentProduct.getByValue(paymentProduct));
        ...
        List<SpiSinglePayment> paymentList = payment.getPayments().stream()
                                                 .map(p -> xs2aToSpiPaymentMapper.mapToSpiSinglePayment(p, paymentProduct))
