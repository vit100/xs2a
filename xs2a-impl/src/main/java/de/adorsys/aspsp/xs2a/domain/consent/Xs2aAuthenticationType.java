...
@ApiModel(description = "AuthenticationObject type", value = "Xs2aAuthenticationType")
public enum Xs2aAuthenticationType {
	...
	Xs2aAuthenticationType(String description) {
