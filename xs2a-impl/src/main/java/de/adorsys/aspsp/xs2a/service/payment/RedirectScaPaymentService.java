...
public class RedirectScaPaymentService extends RedirectAndEmbeddedPaymentService {
    public RedirectScaPaymentService(PaymentSpi paymentSpi, Xs2aToSpiPaymentMapper xs2aToSpiPaymentMapper,
                                     Xs2aToSpiPeriodicPaymentMapper xs2aToSpiPeriodicPaymentMapper,
                                     SpiToXs2aPaymentMapper spiToXs2aPaymentMapper,
                                     PisConsentDataService pisConsentDataService) {
        super(paymentSpi, xs2aToSpiPaymentMapper, xs2aToSpiPeriodicPaymentMapper, spiToXs2aPaymentMapper,
