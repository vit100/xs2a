...
public class ReadPeriodicPayment extends ReadPayment<PeriodicPayment> {
    ...
    public PeriodicPayment getPayment(String paymentId, String paymentProduct) {
        ...
        SpiResponse<SpiPeriodicPayment> spiResponse = paymentSpi.getPaymentById(psuData,
            pisConsentDataService.getAspspConsentDataByPaymentId(paymentId));
        pisConsentDataService.updateAspspConsentData(spiResponse.getAspspConsentData());

        return xs2aPeriodicPaymentMapper.mapToXs2aPeriodicPayment(spiResponse.getPayload());
    }
}
