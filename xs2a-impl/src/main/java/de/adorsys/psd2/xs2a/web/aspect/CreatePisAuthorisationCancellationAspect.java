...
public class CreatePisAuthorisationCancellationAspect extends AbstractLinkAspect<PaymentController> {
    ...
    private Links buildLink(String paymentService, String paymentProduct, String paymentId, String authorizationId) {
        ...
        if (EnumSet.of(EMBEDDED, DECOUPLED).contains(scaApproachResolver.resolveScaApproach())) {
            return addEmbeddedDecoupledRelatedLinks(links, paymentService, paymentProduct, paymentId, authorizationId);
    ...
    private Links addEmbeddedDecoupledRelatedLinks(Links links, String paymentService, String paymentProduct, String paymentId, String authorizationId) {
