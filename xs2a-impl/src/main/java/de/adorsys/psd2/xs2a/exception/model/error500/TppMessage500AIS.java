...
public class TppMessage500AIS {
  ...
  @JsonProperty("code")
  private MessageCode500AIS code = null;
  ...
  **/
  ...
  public TppMessage500AIS code(MessageCode500AIS code) {
    this.code = code;
    return this;
  }
  ...
  **/
  ...
  public MessageCode500AIS getCode() {
    return code;
  }

  public void setCode(MessageCode500AIS code) {
    this.code = code;
  }
