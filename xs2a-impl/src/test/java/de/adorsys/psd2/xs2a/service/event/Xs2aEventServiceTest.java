...
//        // Given
//        RequestHolder requestHolder = buildRequestHolder();
//        ArgumentCaptor<Event> argumentCaptor = ArgumentCaptor.forClass(Event.class);
//
//        // When
//        xs2aEventService.recordAisTppRequest(CONSENT_ID, requestHolder, EVENT_TYPE);
//
//        // Then
...
//
//        // When
//        xs2aEventService.recordPisTppRequest(PAYMENT_ID, requestHolder, EVENT_TYPE);
//
//        // Then
//        verify(eventService).recordEvent(argumentCaptor.capture());
//        Event capturedEvent = argumentCaptor.getValue();
...
//
//        // When
//        xs2aEventService.recordTppRequest(requestHolder, EVENT_TYPE);
//
//        // Then
//        verify(eventService).recordEvent(argumentCaptor.capture());
//        Event capturedEvent = argumentCaptor.getValue();
...
//        requestHolder.setUri(URI);
//        requestHolder.setRequestId(REQUEST_ID);
//        requestHolder.setIp(TPP_IP);
//        requestHolder.setHeaders(Collections.singletonMap("Header", "value"));
