...
public class PaymentControllerTest {
    ...
    public void cancelPayment_WithoutAuthorisation_Success() {
        when(responseMapper.ok(any()))
            .thenReturn(new ResponseEntity<>(getPaymentInitiationCancelResponse204202(de.adorsys.psd2.model.TransactionStatus.CANC), HttpStatus.OK));
        ...
        ResponseEntity<PaymentInitiationCancelResponse204202> expectedResult = new ResponseEntity<>(getPaymentInitiationCancelResponse204202(de.adorsys.psd2.model.TransactionStatus.CANC), HttpStatus.OK);
    ...
    public void cancelPayment_WithAuthorisation_Success() {
        when(responseMapper.accepted(any()))
            .thenReturn(new ResponseEntity<>(getPaymentInitiationCancelResponse204202(de.adorsys.psd2.model.TransactionStatus.ACTC), HttpStatus.ACCEPTED));
        when(paymentService.cancelPayment(any(), any())).thenReturn(getCancelPaymentResponseObject(true));

        // Given
        PaymentType paymentType = PaymentType.SINGLE;
        ResponseEntity<PaymentInitiationCancelResponse204202> expectedResult = new ResponseEntity<>(getPaymentInitiationCancelResponse204202(de.adorsys.psd2.model.TransactionStatus.ACTC), HttpStatus.ACCEPTED);
    ...
    private PaymentInitiationCancelResponse204202 getPaymentInitiationCancelResponse204202(de.adorsys.psd2.model.TransactionStatus transactionStatus) {
