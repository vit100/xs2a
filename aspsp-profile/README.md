...
|consentExpirationSchedulerInvokingPeriodMs | This field contains the period of invoking of consent expiration scheduler set in milliseconds      | 86 400 000                                           | milliseconds (1, 2,...)                                                                               |
