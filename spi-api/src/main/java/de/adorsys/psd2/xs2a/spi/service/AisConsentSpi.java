...
public interface AisConsentSpi extends AuthorisationSpi<SpiAccountConsent> {
     ...
     */
    SpiResponse<SpiAccountAccess> initiateAisConsent(@NotNull SpiContextData contextData, SpiAccountConsent accountConsent, AspspConsentData initialAspspConsentData);
     ...
     */
    @NotNull
    SpiResponse<VoidResponse> verifyScaAuthorisation(@NotNull SpiContextData contextData, @NotNull SpiScaConfirmation spiScaConfirmation, @NotNull SpiAccountConsent accountConsent, @NotNull AspspConsentData aspspConsentData);
}
